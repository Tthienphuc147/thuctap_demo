...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.pages.home')->with(compact('cai_dat_san_pham','san_pham_theo_danh_muc','toan_bo_san_pham_dien_thoai','toan_bo_san_pham_lap_top','toan_bo_san_pham_tablet','toan_bo_san_pham_moi','toan_bo_san_pham_khuyen_mai','toan_bo_san_ban_chay'));
    }
