                                        ...
                                        <div class="col-lg-4">
                                            <div class="shop-add-action mb-xs-30">
                                                <ul class="add-actions-link">
                                                    ...
                                                    <li class="wishlist"><a class="view-list-product" href="javascript:void(0)" onclick="themSpYeuThich({{$sptl->id}})"><i class="fa fa-heart-o"></i>Thêm vào yêu thích</a></li>
                                                    <li><a class="quick-view view-list-product" data-toggle="modal" data-target="#xemnhanhsanpham{{$sptl->id}}" href="#"><i class="fa fa-eye"></i>Xem ngay</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
